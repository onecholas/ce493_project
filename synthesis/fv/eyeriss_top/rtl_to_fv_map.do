...
# Generated on: Tue Dec 09 13:57:53 CST 2025 (Tue Dec 09 19:57:53 GMT 2025)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/eyeriss_top/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/eyeriss_top -revised fv_map
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/buf_array.sv
add_search_path . -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/buffer.sv
add_search_path . -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/eyeriss_top.sv
add_search_path . -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/fifo.sv
add_search_path . -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/noc.sv
add_search_path . -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/pe_array.sv
add_search_path . -design -golden
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../rtl/pe.sv
elaborate_design -golden -root {eyeriss_top} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/eyeriss_top/fv_map.v.gz
elaborate_design -revised -root {eyeriss_top}
...
#add_name_alias fv/eyeriss_top/fv_map.singlebit.original_name.alias.json.gz -revised
