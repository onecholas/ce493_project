add wave -noupdate -group noc_tb
add wave -noupdate -group noc_tb -radix unsigned /noc_tb/*

add wave -noupdate -group noc
add wave -noupdate -group noc -radix unsigned /noc_tb/noc_inst/*
...
for {set r 0} {$r <= 4} {incr r} {
    ...
    for {set c 0} {$c <= 5} {incr c} {
        ...
        set path "/noc_tb/noc_inst/pe_array_inst/rows\[$r\]/cols\[$c\]/pe_inst/*"
