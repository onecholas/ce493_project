add wave -noupdate -group pe_array_tb
add wave -noupdate -group pe_array_tb -radix unsigned /pe_array_tb/*

add wave -noupdate -group pe
add wave -noupdate -group pe -radix unsigned /pe_array_tb/pe_array_inst/*
...
for {set r 0} {$r <= 4} {incr r} {
    ...
    for {set c 0} {$c <= 5} {incr c} {
        ...
        set path "/pe_array_tb/pe_array_inst/rows\[$r\]/cols\[$c\]/pe_inst/*"
